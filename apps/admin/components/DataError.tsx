...
export default function DataError({
  title = "We couldn't load this from FuseCore",
  message,
}: {
  title?: string;
  message?: string | null;
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <p className="text-[11px] text-[var(--jmb-text-mute)] mt-1">
          This is upstream — refresh in a moment, or check Next.js server logs for details.
        </p>
      </div>
    </div>
  );
